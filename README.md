...
[🚀 **Cylinder-Scale-Generator**](https://yourusername.github.io/cylinder-scale-generator/)
...
- **Customizable Appearance** - Dark/light modes, adjustable fonts, tick marks, and labels
...
3. Adjust tick marks and labels as needed
...
- **Ticks** - Tick mark lengths and intervals
